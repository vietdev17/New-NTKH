    ...
    <div className="min-h-[calc(100vh-12rem)] flex items-center justify-center py-12 px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Nhập email để nhận hướng dẫn đặt lại mật khẩu</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-card p-6 lg:p-8">
          {sent ? (
            <div className="text-center py-4">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Email đã được gửi!</h3>
              <p className="text-sm text-gray-500 mb-6">Kiểm tra hộp thư để đặt lại mật khẩu. Email có hiệu lực trong 15 phút.</p>
              <Button asChild variant="outline" className="gap-2">
                <Link href="/login"><ArrowLeft className="h-4 w-4" /> Quay lại đăng nhập</Link>
              </Button>
            </div>
          ) : (
